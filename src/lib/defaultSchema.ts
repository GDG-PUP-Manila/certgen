  ...
  steps: [
      ...
      fields: [
        {
          name: "name",
          label: "Name",
          placeholder: "FirstName MI. LastName (e.g., Sparky G. Lorenzo)",
          type: "text",
          required: true
        },
        {
    ...
    },
    {
      ...
      fields: [
        {
          name: "gdg_id",
          label: "GDG ID (Optional - If you are a registered member)",
          placeholder: "e.g., GDGPUP-26-006767",
          type: "text",
          required: false
        },
        {
        ...
        {
          name: "program",
          label: "Program (Do Not Abbreviate)",
    ...
    },
    {
      ...
      fields: [
        {
          name: "ratings",
          label: "Please rate the event that honestly reflects your opinion.",
          type: "rating_grid",
        ...
        },
        {
          ...
          label: "Overall, how satisfied were you with the event?",
          type: "slider",
        ...
        },
        {
          ...
          label: "What specific topics or aspects of event did you find most valuable or informative?",
          type: "textarea",
          required: true
        },
        {
          name: "missingContent",
          label: "Was there any content or topic you expected but was not covered?",
          type: "textarea"
        },
        {
          name: "suggestions",
          label: "Do you have any other suggestions for improving the event?",
          type: "textarea"
        },
        {
          name: "questionsForSpeakers",
          label: "Do you have questions for the speakers?",
          type: "textarea"
        },
        {
          name: "commentsForSpeakers",
          label: "Do you have comments for the speakers? You may post here your appreciation message to them!",
          type: "textarea"
        }
      ]
    }
